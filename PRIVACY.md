...
26x86 may collect pseudo-anonymized data about the host system and the 26x86 application. This data is used to improve the project and to help diagnose issues. The data collected is as follows:
